...
- Messages from `DISCORD_FORUM_CHANNEL` threads go to `ZULIP_FORUM_CHANNEL` in a topic created from the Discord thread and stored in SQLite.
- Messages in `ZULIP_TEXT_TOPIC` go to the Discord text channel.
- Messages in other topics of `ZULIP_FORUM_CHANNEL` create or reuse Discord forum threads.
