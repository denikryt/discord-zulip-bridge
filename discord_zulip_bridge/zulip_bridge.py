...
class ZulipBridge:
    ...
    async def poll_events(self) -> list[ZulipMessage]:
        ...
        for event in data.get("events", []):
            ...
            if self._bot_email and sender_email == self._bot_email:
                continue
        ...
        while True:
            try:
                ...
                for message in await self.poll_events():
                    if message.stream != stream_name or message.topic != topic_name:
                        continue
